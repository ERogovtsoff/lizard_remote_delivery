...
const STRINGS = {
  ru: {
    ...
    chatGreeting2: 'Расскажите, что хотите заказать — найдём оригинал и назовём точную цену.',
    chatGreeting3: 'Доставка обычно 3–4 недели. Цена финальная, считается после оценки менеджером.',
    chatWhatToSend: 'Можно прислать что угодно из этого:\n🔗 Ссылку на товар (Poizon, Taobao, Pinduoduo)\n📷 Фото или скриншот\n✏️ Описание словами',
  ...
  en: {
    ...
    chatGreeting1: 'Hi! 👋',
    chatGreeting2: 'Tell us what you would like to order — we will find the original and quote the exact price.',
    chatGreeting3: 'Delivery usually takes 3–4 weeks. The price is final, calculated after the manager reviews it.',
    chatWhatToSend: 'You can send any of these:\n🔗 A product link (Poizon, Taobao, Pinduoduo)\n📷 A photo or screenshot\n✏️ A description in words',
