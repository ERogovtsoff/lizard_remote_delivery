...
const STRINGS = {
  ru: {
    ...
    guestWarning: '⚠️ Не удалось загрузить ваш профиль. Часть функций (корзина, избранное, заказы) может быть недоступна. Откройте приложение заново через нашего бота в Telegram.',
    ok: 'Понятно',
  ...
  en: {
    ...
    guestWarning: '⚠️ We could not load your profile. Some features (cart, favorites, orders) may be unavailable. Please reopen the app via our Telegram bot.',
    ok: 'Got it',
