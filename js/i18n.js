...
const STRINGS = {
  ru: {
    ...
    homeHeroTitle: 'LIZARD: Твой доступ к мировым брендам',
    homeHeroText: 'Заказывай оригинальные товары с POIZON напрямую.',
    homeFeature1Title: 'Гарантия качества',
    homeFeature1Text: 'Только проверенный оригинальный товар',
    homeFeature2Title: 'Безопасная покупка',
    homeFeature2Text: 'Возможность примерки при получении. Если не подошло — бесплатный возврат',
    homeFeature3Title: 'Доставка по всей Беларуси',
    homeFeature3Text: 'В любой город — почтой или курьером',
    orderFromChina: 'Заказать из Китая',
    orderViaPoizon: 'через',
    homeInStockTitle: 'А ещё есть товары в наличии в Беларуси',
    homeInStockText: 'Их можно примерить и забрать уже сегодня — не нужно ждать доставки.',
    homeInStockLink: 'Посмотреть товары в наличии →',
    inStock: 'В наличии',
  ...
  en: {
    ...
    homeHeroTitle: 'LIZARD: Your access to global brands',
    homeHeroText: 'Order authentic items directly from POIZON.',
    homeFeature1Title: 'Quality guarantee',
    homeFeature1Text: 'Only verified authentic products',
    homeFeature2Title: 'Safe purchase',
    homeFeature2Text: 'Try on at delivery. Free return if it does not fit',
    homeFeature3Title: 'Delivery across Belarus',
    homeFeature3Text: 'To any city — by post or courier',
    orderFromChina: 'Order from China',
    orderViaPoizon: 'via',
    homeInStockTitle: 'We also have items available in Belarus',
    homeInStockText: 'Try them on and pick up today — no need to wait for delivery.',
    homeInStockLink: 'Browse in-stock items →',
    inStock: 'In Stock',
