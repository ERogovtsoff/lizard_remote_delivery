...
const STRINGS = {
  ru: {
    ...
    chatFileHint: 'Файлы передать через мини-апп напрямую нельзя — после отправки откроется чат с менеджером, и вам нужно будет приложить файл вручную.',
    chatNothingToSend: 'Сначала напишите сообщение или прикрепите файл',
    ...
    photos: 'Файлы',
    openingChat: 'Открываю чат с менеджером…',
    msgCopied: 'Сообщение скопировано — вставьте его в чате',
    cannotOpenChat: 'Не удалось открыть чат — напишите менеджеру @rogovtsoff вручную',
  ...
  en: {
    ...
    chatFileHint: 'Files cannot be sent through the mini app directly — after sending, the chat with the manager will open and you will need to attach the file there.',
    chatNothingToSend: 'Write a message or attach a file first',
    ...
    photos: 'Files',
    openingChat: 'Opening chat with the manager…',
    msgCopied: 'Message copied — paste it in the chat',
    cannotOpenChat: 'Could not open the chat — please write to @rogovtsoff manually',
